...
if "--skip" not in t:
    t = t.replace(
        ...
        '    parser.add_argument("--delay"'
PATCH("Upload fix applied OK")aise=True)ebsite : FAILED ({err})\\n")\n        re
Traceback (most recent call last):
...
Traceback (most recent call last):
  ...
  File "/usr/lib/python3.12/py_compile.py", line 150, in compile
    raise py_exc
py_compile.PyCompileError:   File "gate_sync.py", line 136
    print(f"Syncing {len(images)} image(s) to Live Feed\n"
         ^
SyntaxError: '(' was never closed
...
(venv) hadi@hadi-desktop:~/orange_pi_deploy$ scp "d:\fyp-complete\FYP COMPLETE\orange_pi_deploy\gate_sync.py" hadi@YOUR_PI_IP:~/orange_pi_deploy/gate_sync.py
ssh: Could not resolve hostname your_pi_ip: Name or service not known
scp: Connection closed
(venv) hadi@hadi-desktop:~/orange_pi_deploy$ python3 -m py_compile ~/orange_pi_deploy/gate_sync.py && echo OK
  File "/home/hadi/orange_pi_deploy/gate_sync.py", line 136
    print(f"Syncing {len(images)} image(s) to Live Feed\n"
         ^
SyntaxError: '(' was never closed
